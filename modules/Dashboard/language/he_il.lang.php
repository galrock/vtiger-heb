...
'LBL_SALES_STAGE_FORM_DESC'=>'מראה את כמות ההזדמנויות ההמצטברות ע"י שלבי מכירות נבחרים למשתמשים נבחרים היכן שתאריך הסגירה הצפוי הוא בטווח התאריך הנבחר.',
'LBL_MONTH_BY_OUTCOME'=>'תזרים לפי חודש לפי התוצאה',
'LBL_MONTH_BY_OUTCOME_DESC'=>'מראה את כמות ההזדמנויות ההמצטברות לפי חודש לפי תוצאה של משתמשים נבחרים היכן שתאריך הסגירה הצפוי הוא בטווח התאריך הנבחר. התוצאה מבוססת על מצב מכירה שהוא מכירה סגורה, הפסד מכירה או כל ערך אחר.',
'LBL_LEAD_SOURCE_FORM_TITLE'=>'כל ההזדמנויות לפי סוג הקשר המוביל',
'LBL_LEAD_SOURCE_FORM_DESC'=>'מראה את כמות ההזדמנויות המצטברות לפי מקור מפנה למשתמשים נבחרים.',
'LBL_LEAD_SOURCE_BY_OUTCOME'=>'כל ההזדמנויות לפי סוג הקשר המוביל לפי התוצאות',
'LBL_LEAD_SOURCE_BY_OUTCOME_DESC'=>'מראה את כמות ההזדמנויות המצטברות לפי מקור מפנה לפי תוצאה של משתמשים נבחרים היכן שתאריך הסגירה הצפוי הוא בטווח התאריך הנבחר. התוצאה מבוססת על מצב מכירה שהוא מכירה סגורה, הפסד מכירה או כל ערך אחר.',
'LBL_PIPELINE_FORM_TITLE_DESC'=>'מראה כמויות מצטברות לפי שלבי מכירה נבחרים להזדמנויות שלך היכן שתאריך הסגירה הצפוי הוא בטווח התאריך הנבחר.',
...
"salesbyleadsource" => "מכירות לפי מקור מפנה",
...
"productbypo" => "מוצרים לפי מספפר הזמנה",
