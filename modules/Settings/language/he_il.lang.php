...
'LBL_CURRDEL'=>'המטבע העומד להימחק',

'LBL_NEW_FORM_TITLE'=>'איש קשר חדש',

'LBL_NEW_CURRENCY'=>'מטבע חדש',

'LBL_VIEWING'=>'צפייה',

'LBL_CURRENCY_NAME'=>'שם מטבע',

'LBL_CURRENCY_CODE'=>'קוד המטבע',

'LBL_CURRENCY_SYMBOL'=>'סימן',

'LBL_CURRENCY_CRATE'=>'שער ההמרה',

'LBL_CURRENCY_STATUS'=>'מצב',

'LBL_CURRENCY_TOOL'=>'כלים',

'LBL_CURRENCY_LIST'=>'רשימת מטבעות',


'NTC_DELETE_CONFIRMATION'=>'האם למחוק רשומה זו?',

'LEADCUSTOMFIELDS'=>'שדות מותאמים אישית לקשרים מובילים',

'ACCOUNTCUSTOMFIELDS'=>'שדות מותאמים אישית לחשבונות',
...
'VENDORCUSTOMFIELDS'=>'שדות מותאמים אישית לספקים',

'PRICEBOOKCUSTOMFIELDS'=>'שדות מותאמים אישית למחירונים',

'POCUSTOMFIELDS'=>'שדות מותאמים אישית להזמנות רכישה',
'SOCUSTOMFIELDS'=>'שדות מותאמים אישית להזמנות קנייה',
'QUOTESCUSTOMFIELDS'=>'שדות מותאמים אישית להצעות מחיר',
'INVOICECUSTOMFIELDS'=>'שדות מותאמים אישית לחשבוניות',

'EDITLEADPICKLISTVALUES'=>'עריכת רשימת הבחירה של קשרים מובילים ',

'EDITACCOUNTPICKLISTVALUES'=>'עריכת רשימת הבחירה של חשבונות ',
...
'EDITEVENTPICKLISTVALUES'=>'עריכת רשימת הבחירה של אירועים ',

'EDITTASKPICKLISTVALUES'=>'עריכת רשימת הבחירה של משימות ',

'EDITRSSPICKLISTVALUES'=>'עריכת רשימת הבחירה של RSS',
'EDITVENDORPICKLISTVALUES'=>'עריכת רשימת הבחירה של ספקים',
'EDITPBPICKLISTVALUES'=>'עריכת רשימת הבחירה של מחירונים',
'EDITPOPICKLISTVALUES'=>'עריכת רשימת הבחירה של הזמנות רכישה',
'EDITSOPICKLISTVALUES'=>'עריכת רשימת הבחירה של הזמנות קנייה',
'EDITQUOTEPICKLISTVALUES'=>'עריכת רשימת הבחירה של הצעות מחיר',
'EDITINVOICEPICKLISTVALUES'=>'עריכת רשימת הבחירה של חשבוניות',
...
'LBL_CUSTOM_FIELD_SETTINGS'=>'הגדרות שדה מותאם אישית:',

'LBL_PICKLIST_FIELD_SETTINGS'=>'הגדרת שדה של רשימת בחירה:',
...
'NewCustomField'=>'שדה מותאם אישית חדש',

'NewCustomFieldAltC'=>'שדה מותאם אישית חדש [Alt+c]:',

'FieldName'=>'שם השדה',

'FieldType'=>'סוג השדה',

'FieldLabel'=>'כותרת השדה',
...
'LBL_CUSTOM_FIELDS'=>'שדות מותאמים אישית',

'LBL_ADD_FIELD'=>'יצירת שדה מותאם אישית',

'LBL_CUSTM_MSG'=>'מאפשר לעשות ....',

'PicklistFields'=>' שדות רשימת בחירה',

'LBL_PICKLIST_EDITOR'=>'עורך רשימת בחירה',

'Edit'=>'עריכה',

'LBL_EDIT_FIELD_TYPE'=>'עריכת סוג השדה',
